...
- Section `## 19. Skeleton Loading Pattern`
- Section `## 20. Component Acceptance Checklist` with all 9 checklist groups
- Section `## 21. App Icon Concept`
...
20. Component acceptance checklist (Section 20) contains all 9 checklist groups
...
8. Component acceptance checklist: 9 groups of items, copy-pasteable verbatim by Phase 2+ PLAN.md files before Codex review
